...
export const crashWithFrames = (crash: (ErrorRecord) => void) => (error: Error, unhandledRejection = false) => {
...
export function listenToRuntimeErrors(crash: (ErrorRecord) => void, filename: string = "/static/js/bundle.js") {
